...
public class LogUtil
{
  ...
  public static void init(String prefix)
  {
    ...
    System.out.println(new StringBuilder().append("apppath=").append(apppath).toString());
    

    String file = new StringBuilder().append(apppath).append(File.separator).append(prefix).append("conf").append(File.separator).append("log4j.ini").toString();
